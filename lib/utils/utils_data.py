...
def flip_data(data, args=False):
    ...
    if args == False or args.joint_format.upper() == 'H36M':
        ...
        left_joints = [1, 3, 5, 7, 9, 11, 13, 15, 16, 17]
        right_joints = [2, 4, 6, 8, 10, 12, 14, 18, 19, 20]
    ...
    elif args.joint_format.upper() == 'RTM-66':
        left_joints = [2, 3, 12, 18, 19, 20, 21, 22, 23, 24, 29, 30, 31, 32, 33, 39, 40, 41, 42, 43, 49, 51, 54, 56, 62, 63, 64, 65]
        right_joints = [0, 1, 11, 13, 14, 15, 16, 17, 25, 26, 27, 28, 34, 35, 36, 37, 38, 44, 45, 46, 48, 52, 53, 55, 58, 59, 60, 61]
