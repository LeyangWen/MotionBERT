...
from lib.data.datareader_hand import DataReaderVEHSHand, DataReaderVEHSUpperBodyHand
...
datareader = DataReaderVEHSUpperBodyHand(n_frames=243, sample_stride=1, data_stride_train=81, data_stride_test=243, dt_file=args.dt_file, dt_root=args.dt_root, test_set_keyword=args.test_set_keyword) #, res_w=args.res_w, res_h=args.res_h)
